...
import net.vyky.repository.AuthorityRepository;
...
import net.vyky.service.dto.PasswordChangeDTO;
import net.vyky.web.rest.vm.KeyAndPasswordVM;
import net.vyky.web.rest.vm.ManagedUserVM;

...
class CandidateResourceIT {
    ...
    void createCandidate() throws Exception {
        ...
        assertThat(testCandidate.getPassword()).isEqualTo(DEFAULT_PASSWORD);
        assertThat(testCandidate.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(testCandidate.getToken()).isEqualTo(DEFAULT_TOKEN);
        assertThat(testCandidate.getCreatedAt()).isEqualTo(DEFAULT_CREATED_AT);
        assertThat(testCandidate.getDeletedAt()).isEqualTo(DEFAULT_DELETED_AT);
    }
    ...
    void putExistingCandidate() throws Exception {
        ...
        assertThat(testCandidate.getPassword()).isEqualTo(UPDATED_PASSWORD);
        assertThat(testCandidate.getEmail()).isEqualTo(UPDATED_EMAIL);
        assertThat(testCandidate.getToken()).isEqualTo(UPDATED_TOKEN);
        assertThat(testCandidate.getCreatedAt()).isEqualTo(UPDATED_CREATED_AT);
        assertThat(testCandidate.getDeletedAt()).isEqualTo(UPDATED_DELETED_AT);
    }
    ...
    void partialUpdateCandidateWithPatch() throws Exception {
        ...
        partialUpdatedCandidate.password(UPDATED_PASSWORD).deletedAt(UPDATED_DELETED_AT);

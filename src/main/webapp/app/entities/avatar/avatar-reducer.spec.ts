...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './avatar.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AVATAR_LIST actions', async () => {
    ...
    it('dispatches FETCH_AVATAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AVATAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AVATAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AVATAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AVATAR actions', async () => {
      const expectedActions = [
        {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './config.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONFIG_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONFIG actions', async () => {
      const expectedActions = [
        {

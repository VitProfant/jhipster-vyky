...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './topic.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPIC_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPIC actions', async () => {
      const expectedActions = [
        {

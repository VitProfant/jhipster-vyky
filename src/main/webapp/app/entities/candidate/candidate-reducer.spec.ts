...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './candidate.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CANDIDATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CANDIDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CANDIDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CANDIDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CANDIDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CANDIDATE actions', async () => {
      const expectedActions = [
        {

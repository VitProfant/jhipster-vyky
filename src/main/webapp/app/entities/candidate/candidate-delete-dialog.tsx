...
export const CandidateDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterVykyApp.candidate.delete.question">
        <Translate contentKey="jhipsterVykyApp.candidate.delete.question" interpolate={{ id: candidateEntity.id }}>

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './thumb.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THUMB_LIST actions', async () => {
    ...
    it('dispatches FETCH_THUMB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_THUMB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_THUMB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_THUMB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_THUMB actions', async () => {
      const expectedActions = [
        {

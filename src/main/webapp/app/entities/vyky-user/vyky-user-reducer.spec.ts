...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vyky-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VYKYUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_VYKYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VYKYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VYKYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VYKYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VYKYUSER actions', async () => {
      const expectedActions = [
        {

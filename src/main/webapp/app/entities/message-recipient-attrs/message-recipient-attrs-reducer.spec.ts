...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './message-recipient-attrs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGERECIPIENTATTRS_LIST actions', async () => {
    ...
    it('dispatches FETCH_MESSAGERECIPIENTATTRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MESSAGERECIPIENTATTRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MESSAGERECIPIENTATTRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGERECIPIENTATTRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MESSAGERECIPIENTATTRS actions', async () => {
      const expectedActions = [
        {

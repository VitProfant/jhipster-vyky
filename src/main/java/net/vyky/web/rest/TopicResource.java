...
/**
 * REST controller for managing {@link net.vyky.domain.Topic}.
 */
@RestController
        ...
        Optional<Topic> result = topicRepository
            ...
            .map(existingTopic -> {
                if (topic.getVersion() != null) {
                    existingTopic.setVersion(topic.getVersion());
                }
                ...
                if (topic.getMinimalRole() != null) {
                    existingTopic.setMinimalRole(topic.getMinimalRole());
                }
                ...
                if (topic.getDeletedAt() != null) {
                    existingTopic.setDeletedAt(topic.getDeletedAt());
                }

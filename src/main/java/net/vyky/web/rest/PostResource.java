...
/**
 * REST controller for managing {@link net.vyky.domain.Post}.
 */
@RestController
        ...
        Optional<Post> result = postRepository
            ...
            .map(existingPost -> {
                if (post.getVersion() != null) {
                    existingPost.setVersion(post.getVersion());
                }
                if (post.getLevel() != null) {
                    existingPost.setLevel(post.getLevel());
                }
                ...
                if (post.getMinimalRole() != null) {
                    existingPost.setMinimalRole(post.getMinimalRole());
                }
                if (post.getParentId() != null) {
                    existingPost.setParentId(post.getParentId());
                }
                ...
                if (post.getDeletedAt() != null) {
                    existingPost.setDeletedAt(post.getDeletedAt());
                }

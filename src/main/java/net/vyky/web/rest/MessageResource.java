...
import net.vyky.domain.Message;
import net.vyky.repository.MessageRepository;
...
/**
 * REST controller for managing {@link net.vyky.domain.Message}.
 */
@RestController
        ...
        Optional<Message> result = messageRepository
            ...
            .map(existingMessage -> {
                ...
                if (message.getDeletedAt() != null) {
                    existingMessage.setDeletedAt(message.getDeletedAt());
                }
                if (message.getDeletedByAuthor() != null) {
                    existingMessage.setDeletedByAuthor(message.getDeletedByAuthor());
                }
